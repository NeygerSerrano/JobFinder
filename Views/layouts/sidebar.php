...
<aside id="sidebar" class="fixed left-0 top-0 h-full bg-white shadow-lg transition-all duration-300 z-40 border-r border-gray-200" style="width: 250px;">
    <div class="flex flex-col h-full">
        ...
        <nav class="flex-1 overflow-y-auto p-4">
            ...
            function getLinkClass($controller, $action, $currentController, $currentAction) {
                $baseClass = "sidebar-link flex items-center px-4 py-3 rounded-lg transition-colors duration-200 mb-1 ";
                // Verificar si es la página activa
                if ($currentController == $controller && $currentAction == $action) {
                    // Estilo ACTIVO: Fondo verde claro, texto verde, borde derecho verde
                    return $baseClass . "bg-primary-50 text-primary border-r-4 border-primary font-medium shadow-sm";
                } else {
            ...
            <?php if ($_SESSION['rol'] === 'usuario'): ?>
                ...
                <div class="space-y-1">
                    <a href="index.php?controller=home&action=index" 
                       class="<?= getLinkClass('home', 'index', $currentController, $currentAction) ?>">
                    ...
                    <a href="index.php?controller=datospersonales&action=perfil" 
                       class="<?= getLinkClass('datospersonales', 'perfil', $currentController, $currentAction) ?>">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="index.php?controller=educacion&action=index" 
                       class="<?= getLinkClass('educacion', 'index', $currentController, $currentAction) ?>">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="index.php?controller=experiencia&action=index" 
                       class="<?= getLinkClass('experiencia', 'index', $currentController, $currentAction) ?>">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="index.php?controller=portafolio&action=index" 
                       class="<?= getLinkClass('portafolio', 'index', $currentController, $currentAction) ?>">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="index.php?controller=vacante&action=verVacantes" 
                       class="<?= getLinkClass('vacante', 'verVacantes', $currentController, $currentAction) ?>">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="index.php?controller=postulacion&action=indexUsuario" 
                       class="<?= getLinkClass('postulacion', 'indexUsuario', $currentController, $currentAction) ?>">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <?php elseif ($_SESSION['rol'] === 'empresa'): ?>
                ...
                <div class="space-y-1">
                    ...
                    <a href="index.php?controller=empresa&action=perfil" 
                       class="<?= getLinkClass('empresa', 'perfil', $currentController, $currentAction) ?>">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="index.php?controller=vacante&action=index" 
                       class="<?= getLinkClass('vacante', 'index', $currentController, $currentAction) ?>">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="index.php?controller=postulacion&action=indexEmpresa" 
                       class="<?= getLinkClass('postulacion', 'indexEmpresa', $currentController, $currentAction) ?>">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
