...
<div class="max-w-4xl mx-auto p-6">
    <h1 class="text-3xl font-bold text-gray-800 mb-4">📢 Vacantes</h1>
    <p class="text-gray-600 mb-6">Administra las vacantes de tu empresa.</p>

    <!-- Acciones -->
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
        <a href="index.php?controller=vacante&action=crear" 
           class="block bg-primary text-white font-semibold py-3 px-4 rounded-lg text-center hover:bg-primary-700 transition">
            ➕ Crear nueva vacante
        </a>
        <a href="index.php?controller=vacante&action=ver" 
           class="block bg-secondary text-white font-semibold py-3 px-4 rounded-lg text-center hover:bg-secondary-700 transition">
            👁️ Ver vacantes registradas
        </a>
    </div>
