...
<div class="max-w-4xl mx-auto p-6">
    <h1 class="text-3xl font-bold text-gray-800 mb-4">🎓 Educación</h1>
    <p class="text-gray-600 mb-6">Administra la información educativa de los usuarios.</p>
